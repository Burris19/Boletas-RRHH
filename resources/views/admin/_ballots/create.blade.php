                    ...
                    <tbody>
                      @foreach(config('presupuesto.inputs') as $key => $description)
                        <tr>
                          ...
                          <th>
                            <input type = "number" value="0" class = "form-control pf" style="text-align: center" name="ingreso{{ $key + 1 }}" id="pi{{ $key + 1 }}">
                          </th>
                          <th>
                            <input type = "number" value="0" class = "form-control pf" style="text-align: center" name="egreso{{ $key + 1 }}" id="pe{{ $key + 1 }}">
                          </th>
                          <th>
                            <input type = "number" value="0" class = "form-control pf" style="text-align: center" name="diferencia{{ $key + 1 }}" id="po{{ $key + 1 }}">
                          </th>
                        </tr>
                      @endforeach
                    </tbody>
